...
| F1 | bus: caller-provided limit unbounded (poll/tail/poll_system) | audit | fixed | docs/reviews/crate-audits/convergio-bus.md |
| F2 | bus: per-callsite cap enforcement | audit | fixed | docs/reviews/crate-audits/convergio-bus.md |
| F3 | bus: MAX_PAGE_LIMIT documented | audit | fixed | docs/reviews/crate-audits/convergio-bus.md |
| F4 | bus: README API surface table missing endpoints | audit | fixed | docs/reviews/crate-audits/convergio-bus.md |
| F5 | bus: README "what it is NOT" claim outdated re ADR-0025 | audit | fixed | docs/reviews/crate-audits/convergio-bus.md |
| F6 | bus: AGENTS.md invariant for system.* exception | audit | fixed | docs/reviews/crate-audits/convergio-bus.md |
| F7 | bus: duplicated SELECT projection across four queries | audit | fixed | docs/reviews/crate-audits/convergio-bus.md |
| F8 | bus: missing (topic, seq) partial index for poll_system | audit | fixed | docs/reviews/crate-audits/convergio-bus.md |
| F9 | bus: misc low-severity follow-up | audit | fixed | docs/reviews/crate-audits/convergio-bus.md |
| F10 | bus: README cross-ref to MAX_PAGE_LIMIT cap from F1-F3 | audit | fixed | docs/reviews/crate-audits/convergio-bus.md |
