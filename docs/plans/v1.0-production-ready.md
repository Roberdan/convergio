...
## 1. Stato reale del repo (audit 2026-05-26)

Allineato a `main` (verifica SHAs: 2026-05-26).
...
### Workstream v1.0 già mergiati su `main` — DONE
- ✅ W1 — `A11yGate` phase 1 — `a6084e9`
- ✅ W2 — `PromptInjectionGate` — `6743057`
- ✅ W3 — Smart Thor — `91aca49`
- ✅ W4 — `plan_objectives` + `PlanCoherenceGate` — `384e3a5`
- ✅ W5 — `cvg status --agents` — `379afc1`
- ✅ W7 — OpenAI runner adapter — `6bc0d1f`

### In flight (non ancora su `main`)
- 🚧 W14 — Ontology MVP — IN FLIGHT (#404, #406, #409)

### Ancora mancanti per v1.0 (backlog residuo)
- ⏳ W6, W8, W9, W10, W11, W12 (vedi § 2 / § 3)
...
|---|---|---|---|---|
| W1 | `A11yGate` phase 1 (built-in, no axe) | 4-5 | — | ✅ DONE (`a6084e9`) |
| W2 | `PromptInjectionGate` | 3-4 | — | ✅ DONE (`6743057`) |
| W3 | Smart Thor — esecuzione pipeline reale | 6-8 | — | ✅ DONE (`91aca49`) |
| W4 | `plan_objectives` + `PlanCoherenceGate` | 5-7 | — | ✅ DONE (`384e3a5`) |
| W5 | `cvg status --agents` | 6-9 | — | ✅ DONE (`379afc1`) |
| W6 | Plan template parametrici (`vertical-accelerator-v1`) | 4-6 | W4 | importante |
| W7 | `ai-openai` runner adapter | 3-4 | — | ✅ DONE (`6bc0d1f`) |
...
| W11 | `A11yGate` phase 2 (axe-core capability `a11y.axe`) | 5-7 | W1, W9 | **bloccante v1.0** (demo dependency) |
| W12 | `convergio-edu` vertical accelerator demo | 10-15 | W4, W6, W9 | **demo v1.0 launch** |
| W14 | Ontology MVP | TBD | — | **IN FLIGHT** (#404, #406, #409) |

Workstream **bloccanti v1.0 (residui)**: **W11** (dipendenza diretta
per la demo W12). I precedenti bloccanti **W1–W4** sono già shipped
(vedi § 1).
...
- Guida `docs/agent-instruction-guidelines.md` che spiega come scrivere
...
- [ ] Documento `docs/adr/0008-downloadable-capabilities.md` per autori di
      capability.
