...
| F1-2 | Migration `0700_embeddings.sql` (schema in ADR-0038 § 5.2.3) | F1-1 | applies on fresh `~/.convergio/v3/state.db`; idempotent | **landed**: F1-α ships only the storage table; `sqlite-vec` virtual table deferred to F1-β |
