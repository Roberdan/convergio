...
**`convergio-cli` stats:** 64 `*.rs` files / 52 public items / 10114 lines (under `src/`).

Files approaching the 300-line cap:
- `src/main.rs` (300 lines)
- `src/commands/session.rs` (299 lines)
...
- `src/commands/session_register_and_poll.rs` (285 lines)
